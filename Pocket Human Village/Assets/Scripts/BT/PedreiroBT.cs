...
public class PedreiroBT
{
    private Node rootNode;
    private Character character;

    public PedreiroBT(Character c)
    {
        this.character = c;
        SetupTree();
    }
    ...
    private void SetupTree()
    {
        ...
        //Trabalho
        var IndoQuebrarPedra = new FolhaIndoQuebrarPedra(character);
        var QuebrarPedra = new FolhaQuebrarPedra(character);
        var Trabalho = new Sequence(character, new List<Node> { new Negation(character, ChecaItem), IndoQuebrarPedra, QuebrarPedra });
